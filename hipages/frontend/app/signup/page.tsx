    ...
    <div className="w-full max-w-md bg-white rounded-3xl sm:rounded-[3rem] shadow-2xl p-6 sm:p-10 space-y-7 sm:space-y-8 border border-[#E9DDBF]">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <button
          type="submit"
          disabled={submitting}
          className="w-full bg-[#071D36] text-white py-4 rounded-2xl font-bold hover:scale-[1.02] hover:bg-[#0E2E55] transition-transform flex items-center justify-center gap-2 shadow-lg shadow-[#071D36]/20 disabled:opacity-60 disabled:cursor-not-allowed disabled:hover:scale-100"
        >
          {submitting ? 'Creating…' : <>Create Account <ArrowRight className="w-5 h-5" /></>}
        </button>
      </form>

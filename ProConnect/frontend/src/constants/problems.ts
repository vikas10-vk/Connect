...
export const PROBLEM_SUGGESTIONS: { problem: string; category: string; icon: string }[] = [
  ...
  { problem: 'Hot water system not working',           category: 'Plumbing',                   icon: '' },
  ...
  { problem: 'Paint fence or deck',                    category: 'Painting & Decorating',      icon: '' },
  // Carpentry & Joinery
  { problem: 'Build or repair a deck',                 category: 'Carpentry & Joinery',        icon: '' },
  { problem: 'Install shelving or wardrobes',          category: 'Carpentry & Joinery',        icon: '' },
  ...
  { problem: 'Clean or replace gutters',               category: 'Roofing',                    icon: '' },
  { problem: 'Replace damaged roof tiles',             category: 'Roofing',                    icon: '' },
  ...
  { problem: 'Install a split system air conditioner', category: 'Air Conditioning & Heating', icon: '' },
  { problem: 'Air con service or repair',              category: 'Air Conditioning & Heating', icon: '' },
  { problem: 'Ducted air conditioning installation',   category: 'Air Conditioning & Heating', icon: '' },
  ...
  { problem: 'Install solar panels',                   category: 'Solar & Renewable Energy',   icon: '' },
  { problem: 'Install a home battery system',          category: 'Solar & Renewable Energy',   icon: '' },
  // Concreting & Paving
  { problem: 'Pour a concrete driveway or path',       category: 'Concreting & Paving',        icon: '' },
  { problem: 'Lay bricks or pavers',                   category: 'Concreting & Paving',        icon: '' },
  // Plastering
  { problem: 'Repair cracked or damaged plaster',      category: 'Plastering',                 icon: '' },
  ...
  { problem: 'Gas leak detection or repair',           category: 'Gas Fitting',                icon: undefined },
  // Cleaning
  ...
  { problem: 'Install new bathroom cupboard or storage', category: 'Bathroom Renovation',       icon: '' },
  { problem: 'Update bathroom fixtures and fittings',  category: 'Bathroom Renovation',         icon: '' },
  { problem: 'Bathroom mirror and cabinet installation', category: 'Bathroom Renovation',       icon: '' },
  // Kitchen Renovation
  ...
  { problem: 'Install new kitchen cupboards',          category: 'Kitchen Renovation',          icon: '' },
  { problem: 'Kitchen storage and shelving upgrade',   category: 'Kitchen Renovation',          icon: '' },
  // Carpentry & Joinery
  { problem: 'Install custom cupboard or wardrobe',    category: 'Carpentry & Joinery',         icon: '' },
  { problem: 'Built-in shelving or storage unit',      category: 'Carpentry & Joinery',         icon: '' },
  { problem: 'Linen cupboard or hallway storage',      category: 'Carpentry & Joinery',         icon: '' },
  // Building & Construction
  { problem: 'Build a home extension or addition',     category: 'Building & Construction',     icon: '' },
...
export const CATEGORY_KEYWORDS: [string[], string][] = [
  ...
  [['bathroom reno', 'bathroom renovation', 'ensuite', 'vanity', 'shower replace', 'bath replace', 'new bathroom', 'bathroom storage', 'bathroom cabinet', 'bathroom cupboard', 'bathroom mirror', 'bathroom shelf'], 'Bathroom Renovation'],
  [['kitchen reno', 'kitchen renovation', 'cabinet replace', 'benchtop', 'kitchen install', 'kitchen cupboard', 'kitchen storage', 'new kitchen', 'kitchen cabinet', 'kitchen shelf'], 'Kitchen Renovation'],
  ...
  [['carpentr', 'timber', 'deck', 'shelf', 'shelving', 'pergola', 'wardrobe', 'cupboard', 'door', 'cabinet', 'built-in', 'joinery', 'frame', 'stair', 'balustrade', 'storage unit', 'bookshelf', 'linen cupboard', 'wood', 'wooden'], 'Carpentry & Joinery'],
  [['pest', 'termite', 'rodent', 'cockroach', 'ant', 'spider', 'possum'], 'Pest Control'],
  [['handyman', 'assembly', 'flat.?pack', 'furniture assem', 'odd job', 'tv mount', 'minor repair', 'general repair', 'fix up', 'small job', 'quick fix'], 'Handyman'],

...
async def create_job(
    ...
    # Resolve only the submitted slug/alias. Unknown services must use the
    # explicit /uncategorised pathway instead of silently inferring a trade.
